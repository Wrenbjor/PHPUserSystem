...
$UserTable = "CREATE TABLE IF NOT EXISTS users( uid int NOT NULL AUTO_INCREMENT PRIMARY KEY, user_name VARCHAR(100), first_name VARCHAR(100), last_name VARCHAR(100), email_address VARCHAR(200), profile_pic blob)"
